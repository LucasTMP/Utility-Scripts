...
Set objFSO = CreateObject("Scripting.FileSystemObject")
  ...
  Objtextfile.writeline "<!-----Inventario de Terminais----->"
  Objtextfile.writeline "<!----- CIP ----->"
  Objtextfile.writeline "<!-----2019----->"
  Objtextfile.writeline "<!-----Versão 1 ----->"
  ...
  objtextfile.WriteLine "<center><H1><b> Inventario de Estações </b></h1></center>"
